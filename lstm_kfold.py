"""lstm_kfold.py: Copyright 2020, Sentiment Analysis on Movie Reviews using LSTM-KFold"""
...
print(os.listdir("./"))
df_train = pd.read_csv("./data.tsv", sep="\t")
...
split_idx_list = [int(len(features)/10),int(len(features)*2/10),int(len(features)*3/10),int(len(features)*4/10),int(len(features)*5/10),
                  int(len(features)*6/10),int(len(features)*7/10),int(len(features)*8/10),int(len(features)*9/10),int(len(features)+1)]
...
for i in range(8):
    if i == 0:
        val_x, train_x, test_x = features[:split_idx_list[0]], features[split_idx_list[0]:split_idx_list[7]], features[split_idx_list[7]:split_idx_list[9]]
        val_y, train_y, test_y = encoded_labels[:split_idx_list[0]], encoded_labels[split_idx_list[0]:split_idx_list[7]], encoded_labels[split_idx_list[7]:split_idx_list[9]]
    elif i != 0:
        val_x, train_x, test_x = features[split_idx_list[i-1]:split_idx_list[i]], np.concatenate((features[:split_idx_list[i-1]], features[split_idx_list[i]:split_idx_list[7]])), features[split_idx_list[7]:split_idx_list[9]]
        val_y, train_y, test_y = encoded_labels[split_idx_list[i-1]:split_idx_list[i]], np.concatenate((encoded_labels[:split_idx_list[i-1]],encoded_labels[split_idx_list[i]:split_idx_list[7]])), encoded_labels[split_idx_list[7]:split_idx_list[9]]
...
kfold_result_summary = kfold_result_output % ('LSTMs', statistics.mean(test_acc_list), statistics.stdev(test_acc_list))
